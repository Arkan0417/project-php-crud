...
<body>
    ...
    <a href="form_kemampuan_pemain.php" class="btn btn-primary mt-4 mb-3">Input Data Kemampuan Pemain</a>
        <h3 class="mt-3">Data Kemampuan Pemain</h3>
                            ...
                            //menampilkan data kemampuan dalam bentuk tabel menggunakan perulangan(while)
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="update_kemampuan_pemain.php?id_kemampuan=<?php echo $data['id_kemampuan']; ?>" class="btn btn-primary"> Update </a>
                                <a href="hapus_kemampuan_pemain.php?id_kemampuan=<?=$data['id_kemampuan']?>" class="btn btn-danger" onclick="return confirm('Hapus data ini?')">Hapus</a>
                            </td>
                        </tr>
                        <?php
